...
var stripe = Stripe('pk_test_51Q3jh4052H3vHucoEZEINE61uhbigQwOzz3jtBSK0PYROeJ1cRz7SZoOLX9eCDNiYxdBKwQ5iv4VeQeaPbIaogOK00NYOsphUy');
...
if (signupForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
